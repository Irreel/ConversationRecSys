...
class dataset(object):
    def __init__(self, filename, opt):
        ...
        self.subkg = pkl.load(open('data/dbpedia.pkl', 'rb'))
        self.text_dict = json.load(open('data/line2entity.json', 'r+', encoding="utf8"))

        self.batch_size = opt['batch_size']
        self.max_c_length = opt['max_c_length']
        self.max_r_length = opt['max_r_length']
        self.max_count = opt['max_count']
        self.entity_num = opt['n_dbpedia']
        ...
        self.word2index = json.load(open('data/word2index.json', encoding='utf-8'))
        self.key2index = json.load(open('data/key2index.json', encoding='utf-8'))
    ...
    def prepare_word2vec(self):
        ...
        np.save('word2vec.npy', word2embedding)
